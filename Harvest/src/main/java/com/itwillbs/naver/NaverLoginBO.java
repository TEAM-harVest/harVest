...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "aDQ_dBGTEZLJacdL8QIU"; //클라이언트 아이디
	private final static String CLIENT_SECRET = "_sYDYpUHQ5"; //클라이언트 시크릿
	private final static String REDIRECT_URI = "http://localhost:8080/web/callbackNaver.do";
	...
	public String getAuthorizationUrl(HttpSession session) {
		...
		/*Scribe에서 제공하는 인증 URL 생성 기능을 이용하여 네아로 읹으 URL 생성*/
