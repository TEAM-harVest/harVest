...
<link href="${pageContext.request.contextPath }/resources/harVest_css/header.css" rel="stylesheet">
</head>
<body>
	<header>
		...
		<nav>
			<div>
				...
				<div class="serch_box">
					...
					<button type="submit"><img src="${pageContext.request.contextPath }/resources/harVest_img/search_icon.png" width="20"></button>
				</div>
			</div>
			<div class="menu_link">
				...
				<div class="mypage_box">
					...
					<a href="#"><img src="${pageContext.request.contextPath }/resources/harVest_img/mypage.png" width="30"></a>
				</div>
			</div>
		</nav>
