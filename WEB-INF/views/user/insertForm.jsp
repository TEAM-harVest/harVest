...
<div id="joinWrap">
	...
	<!-- 					기본 프로필 이미지를 src에 넣어둠! -->
					    <img style="width: 500px;" id="preview" src="${pageContext.request.contextPath }/resources/harVest_img/mypage.png">
					    <input type="file" id="upload-image" name="file" accept=".jpg,.png" style="position: absolute; top:181px; left: 63px; font-size: x-large;" onchange="readURL(this);">
					</div>
