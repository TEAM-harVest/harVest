...
//	private String uploadPath;
	...
	public ResponseEntity<UserDTO> mylist(HttpServletRequest request) {
		
		String id =request.getParameter("id");
		
		UserDTO userDto = myPageService.getUser(id);
		ResponseEntity<UserDTO> entity = new ResponseEntity<UserDTO>(userDto,HttpStatus.OK);
	...
	@ResponseBody
	@RequestMapping(value = "/myPage/updateFile", method = RequestMethod.POST)
	public void updateFile (@RequestParam("file") MultipartFile uploadfile,
		...
		try {
			...
			userDto.setProfile(UploadFile.fileUpload(uploadfile, Path));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@ResponseBody
	@RequestMapping(value = "/myPage/mylistUpdate", method = RequestMethod.GET)
	public Map<String, String> mylistUpdate(@RequestParam(value= "value") String value
										   ,@RequestParam(value= "valueNm") String valueNm
										   ,HttpSession session
											) 
	{
		...
		param.put(valueNm, value);
		param.put("id", id);
	
		myPageService.updateUser(param);
		myPageService.getUser(id);
